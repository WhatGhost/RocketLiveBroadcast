...
class MyUserManager(BaseUserManager): 
    def create_user(self,account, nickname,is_student=True,password=None): 
        ...
        user = self.model( account=account,nickname=nickname,is_student=is_student)
    ...
    def create_superuser(self, account,nickname, is_student,password): 
        ...
        birth and password.
        """ 
        user = self.create_user(account=account,nickname=nickname, password=password, is_student=is_student ) 
        user.is_admin = True 
        user.save(using=self._db) 
        return user 
